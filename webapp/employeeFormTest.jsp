...
<body>
    ...
    <div class="container col-md-5">
        <div class="card">
            <div class="card-body">
                <form action="EmployeeWebTest?action=${employee.id != null ? 'edit' : 'add'}" method="POST" onsubmit="return validateForm()">
                    ...
                    <fieldset class="form-group">
                        ...
                        <input type="date" placeholder="mm/dd/yyyy" value="<c:out value='${employee.payment_date}' />" class="form-control" name="payment_date" required="required">
                    </fieldset>
